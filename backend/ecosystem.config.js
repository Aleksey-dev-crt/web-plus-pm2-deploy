...
module.exports = {
  ...
  deploy: {
    production: {
      ...
      'pre-deploy': 'cd ~/mesto/source/backend/ && npm i && npm run build && pm2 start ecosystem.config.js',
      'post-deploy': 'cd ~/mesto/source/backend/ && pm2 reload ecosystem.config.js && pm2 save',
    },
  },
};
